...
public class BlipTicketService {
    ...
    public BlipTicketService(BlipLIMEClient limeClient) {
    ...
    public void closeActiveTickets(String tunnelOriginator) {
        ...
        try {
            ...
            String openTicketId = extractOpenTicketId(response.getBody());
    ...
    private String extractOpenTicketId(Map<String, Object> response) {
        ...
        // Utilizando o Pattern Matching do Java 21 (Switch)
