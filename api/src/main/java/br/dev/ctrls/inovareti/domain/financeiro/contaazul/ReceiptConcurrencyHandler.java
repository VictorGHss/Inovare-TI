...
/**
 * Componente responsável pelo controle de concorrência e locks locais/banco
...
public class ReceiptConcurrencyHandler {
    ...
    /**
     * Adquire um lock em memória para evitar concorrência local imediata.
    ...
    /**
     * Registra o recibo como processado no banco de dados, tratando possíveis colisões de concorrência.
     */
