...
public interface AssetRepositoryPort {
    ...
    long count();
    long countInUse();
    org.springframework.data.domain.Page<br.dev.ctrls.inovareti.modules.asset.domain.model.Asset> findWithFiltersOrderByMaintenanceCountDesc(java.util.UUID categoryId, String status, String search, org.springframework.data.domain.Pageable pageable);
    org.springframework.data.domain.Page<br.dev.ctrls.inovareti.modules.asset.domain.model.Asset> findWithFiltersOrderByCreatedAtDesc(java.util.UUID categoryId, String status, String search, org.springframework.data.domain.Pageable pageable);
}
